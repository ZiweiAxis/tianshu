...
from src.telegram import TelegramClient, TelegramProvider
from src.telegram.telegram_render import semantic_to_telegram_message
...
class TelegramBridge:
    ...
    def __init__(
        ...
        self._token = token or TELEGRAM_BOT_TOKEN or ""
        self._webhook_secret = webhook_secret or TELEGRAM_WEBHOOK_SECRET or ""
...
async def handle_telegram_event(
    ...
    """
    from src.core.translator import TelegramEventTranslator
